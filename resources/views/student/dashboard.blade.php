<x-layouts.app :title="__('Student Dashboard')">
    ...
    <div class="flex flex-col gap-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-5">
            <div class="rounded-xl border p-5 bg-gradient-to-br from-blue-600 to-blue-500 text-white shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium">Mis Posts</p>
            ...
            <div class="rounded-xl border p-5 bg-gradient-to-br from-blue-600 to-blue-500 text-white shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-white dark:text-white">Mis Podcasts</p>
            ...
            <div class="rounded-xl border p-5 bg-gradient-to-br from-blue-600 to-blue-500 text-white shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-white dark:text-white">Mis Videos</p>
            ...
            <div class="rounded-xl border p-5 bg-gradient-to-br from-blue-600 to-blue-500 text-white shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-white dark:text-white">Mis Comentarios</p>
            ...
            <div class="rounded-xl border p-5 bg-gradient-to-br from-blue-600 to-blue-500 text-white shadow-lg">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm text-white dark:text-white">Mis Favoritos</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="rounded-xl border p-5 bg-white dark:bg-neutral-900 shadow-lg">
                    <h2 class="text-lg font-semibold mb-4 dark:text-white">Mi Actividad Reciente En La Última Semana</h2>
                    <div class="space-y-4">
                        <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-neutral-800 rounded-lg">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="text-sm font-medium dark:text-white">Posts Creados</span>
                            </div>
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-neutral-800 rounded-lg">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="text-sm font-medium dark:text-white">Podcasts Creados</span>
                            </div>
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-neutral-800 rounded-lg">
                            <div class="flex items-center gap-3">
                                ...
                                <span class="text-sm font-medium dark:text-white">Videos Creados</span>
                            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-4">
                    <a href="{{ route('posts.create') }}" class="p-4 rounded-xl cursor-pointer bg-white dark:bg-neutral-900 border shadow-lg hover:shadow-md transition-all flex flex-col items-center justify-center group hover:bg-blue-200 dark:hover:bg-blue-800">
                        ...
                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300 group-hover:text-blue-400">Crear Post</span>
                    </a>
                    ...
                    <a href="{{ route('podcasts.create') }}" class="p-4 rounded-xl cursor-pointer bg-white dark:bg-neutral-900 border shadow-lg hover:shadow-md transition-all flex flex-col items-center justify-center group hover:bg-yellow-200 dark:hover:bg-yellow-800">
                        ...
                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300 group-hover:text-yellow-400">Crear Podcast</span>
                    </a>
                    ...
                    <a href="{{ route('video.create') }}" class="p-4 rounded-xl cursor-pointer bg-white dark:bg-neutral-900 border shadow-lg hover:shadow-md transition-all flex flex-col items-center justify-center group hover:bg-red-200 dark:hover:bg-red-800">
                        ...
                        <span class="text-sm font-medium text-gray-700 dark:text-gray-300 group-hover:text-red-400">Crear Video</span>
                    </a>
                </div>

                {{-- Enlaces Rápidos --}}
                <div class="rounded-xl border p-5 bg-white dark:bg-neutral-900 shadow-lg">
                    <h3 class="text-lg font-semibold mb-4 dark:text-white">Enlaces Rápidos</h3>
                    <div class="space-y-3">
                        <a href="{{ route('student.favorites') }}" class="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                            ...
                            <span class="text-sm dark:text-white">Mis Favoritos</span>
                        </a>
                        <a href="{{ route('student.comments') }}" class="flex items-center gap-3 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                            ...
                            <span class="text-sm dark:text-white">Mis Comentarios</span>
                        </a>
                    </div>
                </div>
            </div>
        ...
        {{-- Gráfico de mi contenido --}}
        <div class="rounded-xl border p-5 bg-white dark:bg-neutral-900 shadow-lg">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-lg font-semibold dark:text-white">Mi Contenido</h2>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            new Chart(ctx, {
                type: 'doughnut', // Usamos un gráfico de donut
                data: {
                    labels: ['Posts', 'Podcasts', 'Videos', 'Comentarios', 'Favoritos'], // Etiquetas
                    datasets: [{
                        label: 'Mi Contenido',
                        data: [totales.posts, totales.podcasts, totales.videos, totales.comentarios, totales.favoritos], // Datos
                        ...
                        tooltip: {
                            callbacks: {
                                label: function(tooltipItem) {
                                    return tooltipItem.label + ': ' + tooltipItem.raw + ' elementos';
                                }
                            }
                        }
                    }
